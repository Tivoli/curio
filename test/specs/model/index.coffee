describe 'Model', ->
  ...
  it 'should convert a string to an object id', ->
    ...
    expect(Model.strToID(id)).to.be.instanceof app.mongo.ObjectID

  it 'should preserve an object id', ->
    id = new app.mongo.ObjectID('52d8d736b394b01c4e9aa8a8')
    converted = Model.strToID(id)
    expect(converted).to.be.instanceof app.mongo.ObjectID
  ...
  it 'should convert a date to an object id', ->
    ...
    expect(Model.dateToID(date)).to.be.instanceof app.mongo.ObjectID

  it 'should convert a number to an object id', ->
    expect(Model.dateToID(1)).to.be.instanceof app.mongo.ObjectID
